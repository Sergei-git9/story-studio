...
class StoryPlayer {
    ...
    // НОВАЯ ФУНКЦИЯ: Автовоспроизведение
    async startAutoPlay() {
        ...
        for (let i = this.currentIndex; i < this.currentStory.length; i++) {
            ...
            // Центрируем последнее сообщение
    ...
    async displayMessage(message) {
        ...
        // Плавная прокрутка после каждого сообщения
    ...
    checkForEffects(text) {
        ...
        // Потемнение при упоминании света
    ...
    // Переключение на цветочные лепестки
    ...
    // Автоматическое центрирование последнего сообщения
    centerLastMessage() {
        const container = document.getElementById('chat-window');
